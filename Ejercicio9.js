class ClaseJQuery{
    ...
    cargarDatos(city){
        this.ciudad=city;
        this.url = "http://api.openweathermap.org/data/2.5/weather?q=" + this.ciudad + this.tipo + 
            ...
            $.ajax({
                ...
                success: function(datos){
                        ...
                        var stringDatos = "<img src="+"https://openweathermap.org/img/w/"+icon+".png"+" alt="+descripcion.split(" ")[0]+">";
