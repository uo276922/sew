        ...
        if(this.isOperacionValidad){
            if (this.isOperacion){
                ...
                if (pantalla_aux.length == 2){
                    var operando1 = new Number(eval(pantalla_aux[0]));
                    var operando2 = new Number(eval(pantalla_aux[1]));
                    var result = Math.pow(operando1,operando2);
                }else if(pantalla_aux2.length == 2){
                    var result = Math.pow(10,pantalla_aux2[1]);
                    result = new Number(eval(pantalla_aux2[0]+"*"+result));
                }else{
                    var arrayOperacion = this.pantalla.split(this.simboloOPeracion);
                    this.pantallaAlmacen=this.simboloOPeracion+arrayOperacion[1];
                    var result = new Number(eval(this.pantalla));
    ...
    sin(){
        ...
        if(this.modoTrigoNormal){
            if(this.tipoGrado=="DEG"){
                var numeroPantalla = new Number(eval(this.pantalla));
                numeroPantalla = new Number(eval(numeroPantalla+"*("+Math.PI+"/"+180+")"));
                this.isOperacion=false;
                ...
                var numeroPantalla = new Number(eval(this.pantalla));
                numeroPantalla = new Number(eval(numeroPantalla+"*("+Math.PI+"/"+200+")"));
                this.isOperacion=false;
            ...
            if(this.tipoGrado=="DEG"){
                ...
                numeroPantalla = new Number(eval(numeroPantalla+"*("+180+"/"+Math.PI+")"));
                ...
                numeroPantalla = Math.asin(numeroPantalla);
                numeroPantalla = new Number(eval(numeroPantalla+"*("+200+"/"+Math.PI+")"));
                this.pantalla=numeroPantalla;
                document.getElementsByTagName("input")[0].value = this.pantalla;
            }
        }
